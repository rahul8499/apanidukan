  ...
  switch (type) {
    case 'GARMENTS':
      return {
        ...
        intro: 'नमस्ते! 🙏 हमारा नया फैशन कलेक्शन अब ऑनलाइन उपलब्ध है! आप घर बैठे सभी डिजाइन्स व रेट्स देख सकते हैं:',
    ...
    default:
      return {
        ...
        intro: 'नमस्ते! 🙏 अब आप हमारी दुकान के सभी प्रोडक्ट्स व ऑफर्स सीधे ऑनलाइन देख सकते हैं:',
        itemHighlight: '✓ 📦 संपूर्ण प्रॉडक्ट कॅटलॉग व डेली ऑफर्स',
        categoryEmoji: '🛍'
      }
  }
}
...
function getFulfillmentHighlight(allowHomeDelivery: boolean, allowStorePickup: boolean): string {
  if (allowHomeDelivery && allowStorePickup) {
    return '✓ 🚚 थेट घरपोच डिलिव्हरी (Home Delivery) व 🏬 स्टोअर पिकअप दोन्ही उपलब्ध'
  }
  if (allowHomeDelivery && !allowStorePickup) {
...
/**
 * Generates a high-converting, clean, bulletproof WhatsApp share message.
 */
export function generateStoreShareMessage(store: StoreShareableData, options?: StoreShareOptions): string {
  ...
  const lines: string[] = [
    ...
    `✓ 💯 बेस्ट क्वालिटी व वाजवी दर`,
    `✓ 💬 थेट WhatsApp वर सोपी ऑर्डर`
  ]

  if (options?.couponCode) {
    lines.push('', `🎟️ *Special Discount Code:* ${options.couponCode}`)
  }

  lines.push('', `👉 नवीन प्रोडक्ट्स पाहण्यासाठी लगेच वर दिलेल्या लिंकवर क्लिक करा!`)
