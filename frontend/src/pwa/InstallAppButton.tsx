    ...
    <>
      ...
      {variant === 'header_pill' && (
        <button
          ...
          className="flex h-7 sm:h-8 items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2 sm:px-2.5 text-[10px] sm:text-xs font-black text-slate-900 shadow-xs hover:bg-slate-50 hover:border-slate-300 hover:scale-105 active:scale-95 transition-all cursor-pointer"
          title="Install App on Phone"
        >
          <Smartphone className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-indigo-600 animate-pulse" />
          <span className="text-slate-900 font-black">Install App</span>
        </button>
      )}
