...
class StoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Store
        fields = ('id', 'owner', 'name', 'slug', 'description', 'phone_number', 'logo', 'theme', 'status', 'is_published', 'manage_in_app', 'created_at', 'updated_at', 'settings')
...
class PublicStoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Store
        fields = ('id', 'name', 'slug', 'description', 'logo', 'theme', 'settings', 'phone_number', 'manage_in_app')
